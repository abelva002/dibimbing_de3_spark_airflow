...
docker-build:
	...
	@echo '__________________________________________________________'
	@winpty docker network inspect dataeng-network >/dev/null 2>&1 || docker network create dataeng-network
	@echo '__________________________________________________________'
...
spark-submit-test:
	@docker exec ${SPARK_WORKER_CONTAINER_NAME}-1 \
		...
		/spark-scripts/assignment_spark_file.py
...
postgres-create-table:
	...
	@winpty docker exec -it ${POSTGRES_CONTAINER_NAME} psql -U ${POSTGRES_USER} -d ${POSTGRES_DB} -f sql/ddl-retail.sql
	@echo '==========================================================='
...
postgres-ingest-csv:
	...
	@echo 'Ingesting CSV...'
	@echo '_________________________________________'
	@winpty docker exec -it ${POSTGRES_CONTAINER_NAME} psql -U ${POSTGRES_USER} -d ${POSTGRES_DB} -f sql/ingest-retail.sql
	@echo '==========================================================='
